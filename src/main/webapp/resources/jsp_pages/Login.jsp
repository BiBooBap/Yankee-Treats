...
<form class="form" action="${pageContext.request.contextPath}/login" method="post">
    ...
    <div class="inputForm">
        ...
        <input name="email" placeholder="Inserisci la tua email" class="input" type="text">
    </div>
    ...
    <div class="inputForm">
        ...
        <input name="password" placeholder="Inserisci la tua password" class="input" type="password">
    </div>
