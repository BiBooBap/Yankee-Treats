...
<form class="form" action="${pageContext.request.contextPath}/login" method="post">
    ...
    <div class="inputForm">
        ...
        <input name="email" placeholder="" class="input" type="text">
    </div>
    ...
    <div class="inputForm">
        ...
        <input name="password" placeholder="" class="input" type="password">
    </div>
=======
    <form class="form" action="${pageContext.request.contextPath}/login" method="post">
        <input type="hidden" name="fromCart" value="${param.fromCart}" />
        ...
        <p class="p">
            Non hai un account? <a href="${pageContext.request.contextPath}/resources/jsp_pages/Registration.jsp?fromB2B=${param.fromB2B}&fromCart=${param.fromCart}">Registrati qui</a>
            <% if (request.getParameter("fromCart") != null && request.getParameter("fromCart").equals("true")) { %>
            <br><br><br>
            <a href="${pageContext.request.contextPath}/resources/jsp_pages/Checkout.jsp?guest=true">Premi qui per ordinare senza creare un account</a>
            <% } %>
        </p>

    </form>
>>>>>>> f83483b (Change user logic in Servlet and JSP + Admin Invoice for every order (+ download button))
